 ...
 * @generated
 */
public class ShiroSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ShiroPackage.SECURITY_MANAGER: {
				SecurityManager securityManager = (SecurityManager)theEObject;
				T1 result = caseSecurityManager(securityManager);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShiroPackage.SUBJECT: {
				Subject subject = (Subject)theEObject;
				T1 result = caseSubject(subject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShiroPackage.PRINCIPAL: {
				Principal principal = (Principal)theEObject;
				T1 result = casePrincipal(principal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShiroPackage.ROLE: {
				Role role = (Role)theEObject;
				T1 result = caseRole(role);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShiroPackage.PERMISSION: {
				Permission permission = (Permission)theEObject;
				T1 result = casePermission(permission);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShiroPackage.REALM: {
				Realm realm = (Realm)theEObject;
				T1 result = caseRealm(realm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShiroPackage.SESSION: {
	 ...
	 * @generated
	 */
	public T1 caseSecurityManager(SecurityManager object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseSubject(Subject object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseRealm(Realm object) {
		return null;
	}
